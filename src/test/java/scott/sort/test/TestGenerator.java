...
public class TestGenerator {
	...
	@Before
	public void setup() {
        File file = new File("target/generated/src/test/java/com/smartstream/mi");
        file.mkdirs();
        file = new File("target/generated/src/test/java/com/smartstream/mac");
        file.mkdirs();
    ...
    public void testGenerateMacXmlSpec() throws Exception {
        ...
        FileOutputStream fout = new FileOutputStream(new File("target/generated/src/test/java/com/smartstream/mac/macspec.xml"));
    ...
    public void testGenerateMiXmlSpec() throws Exception {
        ...
        File file = new File("target/generated/src/test/java/com/smartstream/mi/mispec.xml");
