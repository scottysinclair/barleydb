...
create table XSS_XXML_MAPPING (
  ID NUMBER(19) NOT NULL,
  XSYNTAX_MODEL_ID NUMBER(19) NOT NULL,
  SUB_SYNTAX_ID NUMBER(19) NULL,
  XPATH VARCHAR(150) NULL,
  TARGET_FIELD_NAME VARCHAR(150) NULL
);
...
create table XSS_XCSVSTRUCTURE_FIELD (
  ID NUMBER(19) NOT NULL,
  NAME VARCHAR(50) NULL,
  XCSVSTRUCTURE_ID NUMBER(19) NOT NULL,
  COLUMN_INDEX NUMBER(9) NOT NULL,
  OPTIONAL NUMBER(9) NOT NULL
);
...
create table XSS_XCSV_MAPPING (
  ID NUMBER(19) NOT NULL,
  XSYNTAX_MODEL_ID NUMBER(19) NOT NULL,
  XCSVSTRUCTURE_FIELD_ID NUMBER(19) NOT NULL,
  TARGET_FIELD_NAME VARCHAR(150) NULL
);
...
create table XSS_XTEMPLATE_CONTENT (
  ...
  NAME VARCHAR(50) NOT NULL,
  MODIFIED_AT TIMESTAMP NOT NULL,
  XTEMPLATE_ID NUMBER(19) NOT NULL
);
...
create table XSS_XTEMPLATE_DATATYPE (
  ID NUMBER(19) NOT NULL,
  XTEMPLATE_ID NUMBER(19) NOT NULL,
  XDATATYPE_ID NUMBER(19) NOT NULL
);
