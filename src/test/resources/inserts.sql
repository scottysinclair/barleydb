...
insert into SS_TEMPLATE_DATATYPE (TEMPLATE_ID, DATATYPE_ID) values (1, 1);
insert into SS_TEMPLATE_DATATYPE (TEMPLATE_ID, DATATYPE_ID) values (1, 2);
insert into SS_TEMPLATE_DATATYPE (TEMPLATE_ID, DATATYPE_ID) values (2, 1);
insert into SS_TEMPLATE_DATATYPE (TEMPLATE_ID, DATATYPE_ID) values (2, 3);
