...
insert into SS_XMLSTRUCTURE(ID, NAME, MODIFIED_AT) values (1, 'SWIFT-1', '2014-01-01 00:00:00.00000');
insert into SS_XMLSTRUCTURE(ID, NAME, MODIFIED_AT) values (2, 'SWIFT-2', '2014-01-01 00:00:00.00000');

insert into SS_SYNTAX_MODEL (ID, NAME, SYNTAX_TYPE, STRUCTURE_TYPE, USER_ID, STRUCTURE_ID, MODIFIED_AT) values (1, 'syntax-xml-1', 0, 1, 1, 1, '2014-01-01 00:00:00.00000');
insert into SS_SYNTAX_MODEL (ID, NAME, SYNTAX_TYPE, STRUCTURE_TYPE, USER_ID, STRUCTURE_ID, MODIFIED_AT) values (2, 'syntax-xml-2', 1, 1, 2, 2, '2014-01-01 00:00:00.00000');
...
insert into SS_CSVSTRUCTURE_FIELD(ID, NAME, COL_INDEX, OPTIONAL, STRUCTURE_ID) values (1, 'field one', 1, 0, 3);
insert into SS_CSVSTRUCTURE_FIELD(ID, NAME, COL_INDEX, OPTIONAL, STRUCTURE_ID) values (2, 'field two', 2, 0, 3);

insert into SS_CSVSTRUCTURE_FIELD(ID, NAME, COL_INDEX, OPTIONAL, STRUCTURE_ID) values (3, 'f-one', 1, 1, 4);
insert into SS_CSVSTRUCTURE_FIELD(ID, NAME, COL_INDEX, OPTIONAL, STRUCTURE_ID) values (4, 'f-two', 2, 1, 4);
