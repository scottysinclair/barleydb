...
public class RuntimeProperties implements Serializable {
    ...
    private boolean disabledOptimisticLocks = false;
    ...
    public RuntimeProperties disableOptimisticLocks(boolean value) {
        this.disabledOptimisticLocks = value;
        return this;
    }
    ...
    public boolean isDisabledOptimisticLocks() {
        return disabledOptimisticLocks;
    }
}
