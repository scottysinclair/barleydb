...
/**
 * very usefull class which helps with debugging
 * The toString() method called from the debugger populats the refProxy which provides
 * a structured view of the proxied entity in the debugger.
 * @author scott
 *
 */
