...
/**
 * Reads query result data from a stream.
 * @author scott
 *
 */
public interface QueryEntityDataInputStream extends AutoCloseable {

    public QueryResultItem read() throws EntityStreamException;

    /**
     * override close() from autocloseable and specialize the Exception thrown.
     */
