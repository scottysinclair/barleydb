...
public class CoreSpec {
    ...
    public static NodeSpec refersToMany(Class<?> type, NodeSpec nodeType, NodeSpec onwardJoinNodeType) {
        return manyRelation(RelationType.REFERS, type, nodeType, onwardJoinNodeType);
    }
