...
/**
 * PlatformSpec with some common defaults for naming of
 * @author scott
 *
 */
public abstract class CommonDefaultsPlatformSpec extends StaticDefinitions {
    ...
    public CommonDefaultsPlatformSpec(String namespace) {
        super(namespace);
    }
    ...
    public static NodeSpec mandatoryDate() {
        ...
        spec.setLength(50);
        spec.setNullable(Nullable.NOT_NULL);
        spec.setOptimisticLock(false);
        return spec;
    }

    public static NodeSpec optionalDate() {
        NodeSpec spec = mandatoryDate();
